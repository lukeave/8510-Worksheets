...
> changing the number of bins alters the way the data is divided for visualization. the more bins, the more "bars" we have in the histogram for each age,enlarging the x axis and shrinking the y axis.
